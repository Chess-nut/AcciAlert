...
export default function SignUpScreen() {
  ...
  const handleSignUp = () => {
    if (validate()) {
      // Backend not integrated — navigate to tabs on success
        ...
        >
          ...
          <View style={styles.headerBlock}>
            ...
            <View style={styles.stepRow}>
              {['Account', 'Details', 'Verify'].map((step, i) => (
                <View key={step} style={styles.stepItem}>
                  <View style={[styles.stepDot, i === 0 && styles.stepDotActive]}>
                    {i === 0
                      ? <MaterialCommunityIcons name={"pencil" as any} size={12} color="#fff" />
          ...
          <View style={styles.card}>
              ...
              <View key={field.key} style={styles.fieldGroup}>
                ...
                <View style={[
                  ...
                  <MaterialCommunityIcons
                    ...
                    size={20}
                    color={errors[field.key] ? '#B71C1C' : focused[field.key] ? '#B71C1C' : '#bbb'}
            ...
            <View style={styles.fieldGroup}>
              ...
              <View style={[
                ...
                <MaterialCommunityIcons
                  name={"lock-outline" as any}
                  size={20}
                  color={errors.password ? '#B71C1C' : focused.password ? '#B71C1C' : '#bbb'}
                  style={styles.inputIcon}
                />
                <TextInput
                  style={styles.input}
                  ...
                  <View style={styles.strengthBars}>
                    {[1, 2, 3, 4].map((n) => (
                      <View
                        ...
                        style={[
                          styles.strengthBar,
                          { backgroundColor: n <= strength.bars ? strength.color : '#e0e0e0' },
                        ]}
                      />
                    ))}
                  </View>
            ...
            <View style={styles.fieldGroup}>
              ...
              <View style={[
                ...
                !errors.confirmPassword && form.confirmPassword.length > 0 && form.password === form.confirmPassword && styles.inputWrapperSuccess,
              ]}>
                <MaterialCommunityIcons
                  name={"lock-check-outline" as any}
                  size={20}
                  color={
                    errors.confirmPassword ? '#B71C1C'
                    : !errors.confirmPassword && form.confirmPassword && form.password === form.confirmPassword ? '#2E7D32'
                    : focused.confirmPassword ? '#B71C1C' : '#bbb'
                  }
                  style={styles.inputIcon}
                />
                <TextInput
                ...
                <TouchableOpacity onPress={() => setShowConfirm(!showConfirm)} style={styles.eyeBtn}>
                  <MaterialCommunityIcons
                    name={(showConfirm ? 'eye-off-outline' : 'eye-outline') as any}
                    size={20}
                    color="#bbb"
                  />
                </TouchableOpacity>
              ...
              {!errors.confirmPassword && form.confirmPassword.length > 0 && form.password === form.confirmPassword && (
                <View style={styles.errorRow}>
                  <MaterialCommunityIcons name={"check-circle-outline" as any} size={13} color="#2E7D32" />
                  <Text style={[styles.errorText, { color: '#2E7D32' }]}>Passwords match!</Text>
                </View>
              )}
            </View>
            ...
            <TouchableOpacity
              ...
              onPress={() => { setAgreedToTerms(!agreedToTerms); setTermsError(''); }}
              activeOpacity={0.7}
            >
              <View style={[styles.checkbox, agreedToTerms && styles.checkboxChecked]}>
                {agreedToTerms && (
                  <MaterialCommunityIcons name={"check" as any} size={14} color="#fff" />
                )}
              </View>
            ...
            <TouchableOpacity style={styles.submitButton} onPress={handleSignUp} activeOpacity={0.85}>
              <MaterialCommunityIcons name={"account-plus" as any} size={20} color="#fff" />
